...
CREATE TABLE employee_store (
    employee_store_id  INT              NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE storemenu (
    storemenu_id  INT             NOT NULL GENERATED ALWAYS AS IDENTITY,
    store_id      INT             NOT NULL,
...
CREATE TABLE menuitem (
    menuitem_id   INT              NOT NULL GENERATED ALWAYS AS IDENTITY,
    menu_id       INT              NOT NULL,
...
CREATE TABLE recipeingredients (
    recipeingredient_id  INT              NOT NULL GENERATED ALWAYS AS IDENTITY,
    recipe_id            INT              NOT NULL,
...
CREATE TABLE inventory (
    inventory_id   INT              NOT NULL GENERATED ALWAYS AS IDENTITY,
    store_id       INT              NOT NULL,
    product_id     INT              NOT NULL,
    quantity       DECIMAL(10,2)    NOT NULL,
